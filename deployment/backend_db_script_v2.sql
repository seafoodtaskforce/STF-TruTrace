...
CREATE TABLE `document_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=87 DEFAULT CHARSET=utf8 COMMENT='name - is the key to the resource name of the data\nvalue - will be ommited in future versions and will be looked up based on the key (i.e. name)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dynamic_field_data` (
  ...
  `value` varchar(200) DEFAULT NULL COMMENT 'The actual value stored in the field',
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='This is the table to store synami field data definition';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `group_data_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=488 DEFAULT CHARSET=utf8 COMMENT='name - is the key to the resource name of the data\nvalue - will be ommited in future versions and will be looked up based on the key (i.e. name)\nvalue_id - will be used to fetch internationalized values for the actual name.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'wwf_shrimp_database_v2'
--
...
-- Dump completed on 2020-05-14 16:09:45
