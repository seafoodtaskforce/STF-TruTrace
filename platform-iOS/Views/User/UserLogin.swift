...
struct UserLogin: View {
    ...
    func loadAuthData() {
        ...
        guard let url = URL(string:
            (RESTServer.REMOTE_SERVER_URL + RESTServer.REST_USER_POST_AUTHENTICATE))
    ...
    func loadDocumentData() {
        guard let url = URL(string:
            (RESTServer.REMOTE_SERVER_URL + RESTServer.REST_USER_GET_DOCUMENTS_ALL))
    ...
    func loadRecipientData() {
        guard let url = URL(string:
            (RESTServer.REMOTE_SERVER_URL + RESTServer.REST_GET_USER_ALL))
