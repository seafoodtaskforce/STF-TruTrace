...
struct NewDocumentDetails: View {
    ...
    func deletePageItems(at offsets: IndexSet){
        ...
        for index in offsets {
            sessionData.newWorkDocument.pages[index].deleted = true
        }
    }
    ...
    func deleteRecipientItems(at offsets: IndexSet){
        sessionData.newWorkDocument.toRecipients.remove(atOffsets: offsets)
    }
    ...
    func deleteLinkedDocItems(at offsets: IndexSet){
        sessionData.newWorkDocument.linkedDocuments.remove(atOffsets: offsets)
    ...
    func deleteBackingDocItems(at offsets: IndexSet){
        sessionData.newWorkDocument.attachedDocuments.remove(atOffsets: offsets)
    ...
    func deleteTagItems(at offsets: IndexSet){
        sessionData.newWorkDocument.tags.remove(atOffsets: offsets)
    }
    ...
    func getDocumentTags() -> [DocumentTag]{
        return sessionData.newWorkDocument.tags

    }
    
    func getDocumentBackingDocs() -> [DocumentDTO]{
        return sessionData.newWorkDocument.attachedDocuments
    }
    
    func getDocumentLinkedDocs() -> [DocumentDTO]{
        return sessionData.newWorkDocument.linkedDocuments
    }
    
    func getDocumentRecipients() -> [Recipient]{
        return sessionData.newWorkDocument.toRecipients
    ...
    func uploadNewDocument(document : DocumentDTO, pages : [DocumentPage]) {
        ...
        guard let url = URL(string:
            (RESTServer.REMOTE_SERVER_URL + RESTServer.REST_POST_CREATE_NEW_DOCUMENT))
