...
struct BackupDocsFilterView: View {
    ...
    private func initDataFromFilter(){
        dateRangeFrom = self.sessionData.feedDocumentList[self.sessionData.feedDocumentList.count - 1].creationTimestampDate ?? Date()
        // Rest of data
...
struct BackupDocsFilterView_Previews: PreviewProvider {
    static var previews: some View {
        BackupDocsFilterView().environmentObject(SessionData())
    }
}
