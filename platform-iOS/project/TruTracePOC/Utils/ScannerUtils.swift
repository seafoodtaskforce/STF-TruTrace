    ...
    final class Coordinator: NSObject, VNDocumentCameraViewControllerDelegate {
        ...
        func addNewPage(image : UIImage){
            ...
            if let index = parent.sessionData.myDocumentList.firstIndex(of: document) {
                ...
                parent.sessionData.myDocumentList[index].pages.append(DocumentPage(localImage: image, pageNumber: DocumentDataUtils.getNextPageIndex(document : parent.sessionData.myDocumentList[index])))
                print("Adding a new page <after>: .\(parent.sessionData.myDocumentList[index].pages.count)")
                print("Adding a new page <all>: .\(parent.sessionData.myDocumentList[index].pages)")
            }
