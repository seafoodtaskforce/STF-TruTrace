...
public class ConfigurationData {
    ...
    private String restDocumentFetchRecipientsForUserURL;
    ...
    public String getRestDocumentFetchRecipientsForUserURL() {
        return restDocumentFetchRecipientsForUserURL;
    }
