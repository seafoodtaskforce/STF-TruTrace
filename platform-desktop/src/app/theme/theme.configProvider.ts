...
export class BaThemeConfigProvider {
  ...
  constructor() {
    ...
    this.dashboardColors = {
      ...
      white: '#ffffff',
      mcpdDocColor: '#0033cc',
      captainStatementDocColor: '#F2AB00',
      fishingLogBookDocColor: '#ff0000',
      feedLotSheetDocColor: '#ffff00',
      fishmealLotTraceabilityDocColor: '#E040FB',
    };
    ...
    this.conf = {
      ...
      colors: {
        ...
        dashboard: {
          ...
          mcpdDocColor: this.dashboardColors.mcpdDocColor,
          captainStatementDocColor: this.dashboardColors.captainStatementDocColor,
          fishingLogBookDocColor: this.dashboardColors.fishingLogBookDocColor,
          feedLotSheetDocColor: this.dashboardColors.feedLotSheetDocColor,
          fishmealLotTraceabilityDocColor: this.dashboardColors.fishmealLotTraceabilityDocColor,
